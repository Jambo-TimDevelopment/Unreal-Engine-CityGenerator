...
void FStreetMapComponentDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	...
	[
		...
		[
			SNew(SButton)
			.ToolTipText(LOCTEXT("CreateCreateBuildingsAsset_Tooltip", "Create a new Building blueprints from selected StreetMapComponent."))
		.OnClicked(this, &FStreetMapComponentDetails::OnCreateBuildingsClicked)
		.IsEnabled(bCanCreateMeshAsset)
		.HAlign(HAlign_Center)
			[
				SNew(STextBlock)
			.Text(LOCTEXT("CreateBuildingsBlueprint", "Create Buildings Asset"))
		.Font(IDetailLayoutBuilder::GetDetailFont())
			]
		]
	];
	...
	[
		...
		[
			SNew(SButton)
			.ToolTipText(LOCTEXT("CreateCreateRoadAsset_Tooltip", "Create a new Building blueprints from selected StreetMapComponent."))
		.OnClicked(this, &FStreetMapComponentDetails::OnCreateRoadsClicked)
		.IsEnabled(bCanCreateMeshAsset)
		.HAlign(HAlign_Center)
			[
				SNew(STextBlock)
			.Text(LOCTEXT("CreateBuildingsBlueprint", "Create Road Asset"))
		.Font(IDetailLayoutBuilder::GetDetailFont())
			]
		]
	];
...
FReply FStreetMapComponentDetails::OnCreateBuildingsClicked()
{
	if (SelectedStreetMapComponent != nullptr)
	{
		//
		...
		SelectedStreetMapComponent->GenerateBuildings();
...
FReply FStreetMapComponentDetails::OnCreateRoadsClicked()
{
	if (SelectedStreetMapComponent != nullptr)
	{
		//
		...
		SelectedStreetMapComponent->GenerateRoads();
