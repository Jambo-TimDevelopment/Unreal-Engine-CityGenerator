...
public:
	...
	/** Spawn buildings blueprint and setup on the map */
...
protected:
	...
	UPROPERTY()
	TArray<class AStreetMapSplineRoads*> RoadActors;
	...
	UPROPERTY()
	TSubclassOf<class AStreetMapSplineBuilding> StreetMapSplineBuildingClass;

	UPROPERTY()
	TSubclassOf<class AStreetMapSplineRoads> StreetMapSplineRoadClass;

	UPROPERTY()
	TSubclassOf<class AStreetMapPointNode> StreetMapPointNodeClass;
};
